...
public class ManipulaString {
	...
	public static void main(String[] args) {
		...
		System.out.println("Exibir do 2º ao 4º caracter: " + email.substring(0,6));
		System.out.println("Do 3º caracter em diante: " + email.substring(4,9));
		...
		System.out.println("Comparação: " + email.contentEquals("vitor.vieira@itau-unibanco.com.br"));
	}
}
