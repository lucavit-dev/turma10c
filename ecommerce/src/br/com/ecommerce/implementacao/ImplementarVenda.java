...
public class ImplementarVenda {
	...
	public static void main(String[] args) {
		...
		produto.setDescricao(Magica.s("Descrição").toUpperCase());
		...
		endereco.setLogradouro(Magica.s("Endereço Cliente").toUpperCase());
		endereco.setNumero(Magica.s("Número"));
		endereco.setComplemento(Magica.s("Complemento").toUpperCase());
		endereco.setBairro(Magica.s("Bairro").toUpperCase());
		endereco.setCidade(Magica.s("Cidade").toUpperCase());
		endereco.setEstado(Magica.s("Estado").toUpperCase());
